        ...
        <a-menu mode="horizontal">
          <a-menu-item>
            <a-upload
              ...
              :action="$http.baseURL + $api.AUTH_UPLOAD"
              @change="uploadChange"
          ...
          <a-dropdown :trigger="['click']" :placement="'topLeft'">
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a
                  target="_blank"
                  :href="$http.baseURL + $api.AUTH_TEMPLATE"
                >{{ $t('common.export_template') }}</a>
              </a-menu-item>
              <a-menu-item>
                <a
                  href="javascript:void(0)"
                  @click="download($api.AUTH_DOWNLOAD, selectedRowKeys)"
...
export default {
  ...
  methods: {
    ...
    onDeleteConfirmOk(id) {
      ...
      this.delete(this.$api.AUTH_DELETE, ids)
    }
  }
}
</script>
